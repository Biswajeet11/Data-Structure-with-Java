...
public class DistanceBetweenNodes {
  ...
  public static int distanceBetweenNodes(Node<Integer> node, int k1, int k2) {
  ...
  public static void main(String[] args) {
    ...
    Node<Integer> root = distance.construct(arr);
    int k1 = 110;
    int k2 = 100;
    int distanceData = distanceBetweenNodes(root, k1, k2);
