...
2 is in place 5 and 4 is in place 6), the inverse will be 416253 (reading from right to left, 3 is in place 1, 5 is in place 2,
...
public class InverseNumber {
  ...
  public static int inversedNumber(int n) {
    ...
    while (n != 0) {
      ...
      int id = op;
      int ip = od;
      val = val + (int) (id * Math.pow(10, ip - 1));
      op++;
      n = n / 10;
    }
    return val;
  ...
  public static void main(String[] args) {
    ...
    int n = sc.nextInt();
    int getInversedNumber = inversedNumber(n);
    System.out.println(getInversedNumber);
